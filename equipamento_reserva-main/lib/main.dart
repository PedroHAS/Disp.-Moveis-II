...
import 'package:equipamento_reserva/EquipamentosPage.dart';
import 'package:equipamento_reserva/CadastroEquipamentoPage.dart';
...
class MyApp extends StatelessWidget {
  final appTitle = 'Gerenciamento de Equipamentos';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/consulta': (context) => EquipamentosPage(),
